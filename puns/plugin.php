			...
			<div id="stat_tab_config" class="tab">
				...
				<form method="post">
					...
					<div class="checkbox" style="padding-left: 10pt;border-left:1px solid blue;border-bottom:1px solid blue;">
						...
						<p>If selected, checks against GitHub's API will be authenticated with your username and a [personal access token](https://github.com/settings/tokens) (PAT). This dramatically increases the hourly rate limit. Leave unchecked for anononymity and to be limited to 50 calls per hour.</p> 
						<p>note: personal access token needs NO scopes assigned to it to work with PUNS</p>
					</div>
					<br>
					...
					<div style="padding-left: 10pt;border-left:1px solid blue;border-bottom:1px solid blue;">
						<p><label for="puns_github_user">GitHub Username</label> <input type="text" size=40 id="puns_github_user" name="puns_github_user" value="$ghU" /></p>
						<p><label for="puns_github_pass">GitHub PAT</label> <input type="password" size=40 id="puns_github_pass" name="puns_github_pass" value="$ghP" /></p>
					</div>
					<br>
